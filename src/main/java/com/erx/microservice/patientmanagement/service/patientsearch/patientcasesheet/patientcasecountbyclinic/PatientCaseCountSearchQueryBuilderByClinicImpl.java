package com.erx.microservice.patientmanagement.service.patientsearch.patientcasesheet.patientcasecountbyclinic;
...
@Service("patientCaseCountSearchQueryBuilderByClinic")
public class PatientCaseCountSearchQueryBuilderByClinicImpl implements PatientCaseCountSearchQueryBuilderByClinic {
    private final Logger log = LoggerFactory.getLogger(PatientCaseCountSearchQueryBuilderByClinicImpl.class);
    ...
    public Page<PatientCaseCountSearchDTO> getPatientSearchResults(PatientSearchServiceRequest request) {
       ...
       Page<PatientCaseCountSearchDTO> patientCaseCountSearchDTOPage = null;
        try {
            ...
            patient = patientRepository.getPatientDetailsByClinic(request.getPatientSearchCriteria().getClinicId(),request.getPatientSearchCriteria().getSearchValue(),pageable);
            if(patient != null)
            ...
            log.error("failed to retrieve patient and case count");
        }
