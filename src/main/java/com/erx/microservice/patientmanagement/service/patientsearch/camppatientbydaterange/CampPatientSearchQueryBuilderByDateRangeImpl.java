...
@Service("campPatientSearchQueryBuilderByDateRange")
public class CampPatientSearchQueryBuilderByDateRangeImpl implements CampPatientSearchQueryBuilderByDateRange {

    private final Logger log = LoggerFactory.getLogger(CampPatientSearchQueryBuilderByDateRangeImpl.class);
    ...
    public List<CampRegistrationDTO> getCampPatientSearchResults(PatientSearchCriteria patientSearchCriteria) {
        ...
        try {
            if (patientSearchCriteria.getClinicId() != null & patientSearchCriteria.getSearchType() != null & patientSearchCriteria.getSearchValue() != null) {
                ...
                whereClause = " where p.recordStatus= 1 and p.clinic.id= " + patientSearchCriteria.getClinicId() + " and p.patientRegisteredDate BETWEEN '" + startDate + "' AND '" + endDate + "' ORDER BY pcr.createdOn DESC";
