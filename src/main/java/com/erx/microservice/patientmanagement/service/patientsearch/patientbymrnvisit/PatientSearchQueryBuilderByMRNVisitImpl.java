...
@Service("patientSearchQueryBuilderByMRNVisit")
public class PatientSearchQueryBuilderByMRNVisitImpl implements PatientSearchQueryBuilderByMRNVisit {

    private final Logger log = LoggerFactory.getLogger(PatientSearchQueryBuilderByMRNVisitImpl.class);
