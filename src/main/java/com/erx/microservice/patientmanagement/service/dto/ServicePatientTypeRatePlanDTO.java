...
public class ServicePatientTypeRatePlanDTO extends BaseModelDTO implements Comparable<ServicePatientTypeRatePlanDTO> {
     ...
     */
    @Override
    public int compareTo(ServicePatientTypeRatePlanDTO o) {
        if(o != null)
