package com.erx.microservice.patientmanagement.service.patientsearch.patientbyname;
...
@Service("patientSearchQueryBuilderByName")
public class PatientSearchQueryBuilderByNameImpl implements PatientSearchQueryBuilderByName {

    private final Logger log = LoggerFactory.getLogger(PatientSearchQueryBuilderByNameImpl.class);
    ...
    public List<PatientSearchDTO> getPatientSearchResults(PatientSearchCriteria patientSearchCriteria) {
        ...
        try {
            ...
            if (patientSearchCriteria.getClinicId() != null & patientSearchCriteria.getSearchType() != null & patientSearchCriteria.getSearchValue() != null) {
                whereClause = " where p.recordStatus= 1 and p.registered = TRUE and NOT p.patientIdExternal=null and p.clinic.id= " + patientSearchCriteria.getClinicId() + " and p.patientName like '%" + patientSearchCriteria.getSearchValue() + "%' ";
