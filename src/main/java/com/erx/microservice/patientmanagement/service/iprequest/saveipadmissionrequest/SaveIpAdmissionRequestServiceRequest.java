...
public class SaveIpAdmissionRequestServiceRequest implements CommonServiceRequest {
    ...
    public SaveIpAdmissionRequestServiceRequest(Long cmMasterId, LocalDateTime ipAdmissionDate, Long userId,
    ...
    public SaveIpAdmissionRequestServiceRequest() {
    }
