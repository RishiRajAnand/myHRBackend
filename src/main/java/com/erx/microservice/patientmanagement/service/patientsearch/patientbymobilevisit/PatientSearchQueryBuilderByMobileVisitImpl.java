...
@Service("patientSearchQueryBuilderByMobileVisit")
public class PatientSearchQueryBuilderByMobileVisitImpl implements PatientSearchQueryBuilderByMobileVisit {

    private final Logger log = LoggerFactory.getLogger(PatientSearchQueryBuilderByMobileVisitImpl.class);
    ...
    public List<PatientSearchDTO> getPatientSearchResults(PatientSearchCriteria patientSearchCriteria) {
        ...
        try {
            ...
            if (patientSearchCriteria.getClinicId() != null & patientSearchCriteria.getSearchType() != null & patientSearchCriteria.getSearchValue() != null) {
                whereClause = " where p.recordStatus= 1 and NOT p.patientIdExternal=null and p.clinic.id= " + patientSearchCriteria.getClinicId() + " and p.mobileNumber = '" + patientSearchCriteria.getSearchValue() + "'";
