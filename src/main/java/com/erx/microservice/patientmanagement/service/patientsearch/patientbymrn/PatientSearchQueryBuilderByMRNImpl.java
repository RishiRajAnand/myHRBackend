 ...
 */
@Service("patientSearchQueryBuilderByMRN")
public class PatientSearchQueryBuilderByMRNImpl implements PatientSearchQueryBuilderByMRN {
    ...
    public List<PatientSearchDTO> getPatientSearchResults(PatientSearchCriteria patientSearchCriteria) {
        ...
        PatientAdditionalDetail patientAdditionalDetail = new PatientAdditionalDetail();
            /*javax.persistence.criteria.Order order = ascending ? builder.asc(entityRoot.get(patientSearchCriteria.getSearchType()))
        ...
        try {
            ...
            if (patientSearchCriteria.getClinicLocationId() != null & patientSearchCriteria.getSearchType() != null
                ...
                whereClause = " where p.recordStatus= 1 and p.clinic.id= " + patientSearchCriteria.getClinicId()
                        + " and p.patientIdExternal = '" + patientSearchCriteria.getSearchValue() + "'";
