...
@Service("dischargeRequestTrackerByMobile")
public class DischargeRequestTrackerByMobileImpl implements DischargeRequestTrackerByMobile {

    private final Logger log = LoggerFactory.getLogger(DischargeRequestTrackerByMobileImpl.class);
    ...
    public List<DischargeRequestDTO> getDischargeRequestSearch(PatientSearchCriteria patientSearchCriteria, Pageable pageable) {
        ...
        try {
            log.debug("DischargeRequestTrackerByClinicLocationImpl ==> Call to retrieve DischargeRequest by Mobile");
            ...
            if (patientSearchCriteria.getClinicId() != null & patientSearchCriteria.getSearchType() != null
                ...
                whereClause = " where dr.recordStatus = 1 and cl.id= " + patientSearchCriteria.getClinicLocationId()
                        + " and p.mobileNumber = '" + patientSearchCriteria.getSearchValue() + "' ORDER BY dr.createdOn DESC";
