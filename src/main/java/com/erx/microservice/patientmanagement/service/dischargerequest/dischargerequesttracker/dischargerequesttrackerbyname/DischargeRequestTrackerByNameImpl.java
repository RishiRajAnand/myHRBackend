package com.erx.microservice.patientmanagement.service.dischargerequest.dischargerequesttracker.dischargerequesttrackerbyname;
...
@Service("dischargeRequestTrackerByName")
public class DischargeRequestTrackerByNameImpl implements DischargeRequestTrackerByName {

    private final Logger log = LoggerFactory.getLogger(DischargeRequestTrackerByNameImpl.class);
    ...
    public List<DischargeRequestDTO> getDischargeRequestSearch(PatientSearchCriteria patientSearchCriteria, Pageable pageable) {
        ...
        try {
            log.debug("DischargeRequestTrackerByClinicLocationImpl ==> Call to retrieve DischargeRequest by Name");
