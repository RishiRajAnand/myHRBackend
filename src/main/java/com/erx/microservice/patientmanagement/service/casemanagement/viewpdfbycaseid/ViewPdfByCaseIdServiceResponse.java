...
public class ViewPdfByCaseIdServiceResponse extends CommonServiceResponse {
    ...
    public ViewPdfByCaseIdServiceResponse() {
    }

    public ViewPdfByCaseIdServiceResponse(GetComplaintsDTO getComplaintsDTO, List<CmMedicineTreatmentResponseDTO> cmMedicineTreatmentResponseDTOs,
