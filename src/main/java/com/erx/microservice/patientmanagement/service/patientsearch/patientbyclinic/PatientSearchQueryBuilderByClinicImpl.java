...
import com.erx.microservice.patientmanagement.service.dto.VisitTypeMasterDTO;
...
@Service("patientSearchQueryBuilderByClinic")
public class PatientSearchQueryBuilderByClinicImpl implements PatientSearchQueryBuilderByClinic {

    private final Logger log = LoggerFactory.getLogger(PatientSearchQueryBuilderByClinicImpl.class);
    ...
    public List<PatientSearchDTO> getPatientSearchResults(PatientSearchCriteria patientSearchCriteria) {
        ...
        List<VisitTypeMaster> visitTypeMasters = new ArrayList<VisitTypeMaster>();
        try {
            ...
            if (patientSearchCriteria.getClinicId() != null & patientSearchCriteria.getSearchType() != null & patientSearchCriteria.getSearchValue() != null) {
                whereClause = " where p.recordStatus= 1 and p.registered = TRUE and NOT p.patientIdExternal=null and p.clinic.id= " + patientSearchCriteria.getClinicId() + " ";
                ...
                for (Object[] ipAdmissionDetail : patientResults) {
                    ...
                    visitTypeMasters = visitTypeMasterRepository.getVisitTypeMasterByClinicLocation(patientSearchCriteria.getClinicLocationId());
