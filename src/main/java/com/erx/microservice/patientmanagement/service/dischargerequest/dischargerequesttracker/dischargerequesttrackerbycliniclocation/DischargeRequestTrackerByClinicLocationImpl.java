...
@Service("dischargeRequestTrackerByClinicLocation")
public class DischargeRequestTrackerByClinicLocationImpl implements DischargeRequestTrackerByClinicLocation {

    private final Logger log = LoggerFactory.getLogger(DischargeRequestTrackerByClinicLocationImpl.class);
    ...
    public List<DischargeRequestDTO> getDischargeRequestSearch(PatientSearchCriteria patientSearchCriteria, Pageable pageable) {
        ...
        try {
            log.debug("DischargeRequestTrackerByClinicLocationImpl ==> Call to retrieve DischargeRequest by Clinic Location");
