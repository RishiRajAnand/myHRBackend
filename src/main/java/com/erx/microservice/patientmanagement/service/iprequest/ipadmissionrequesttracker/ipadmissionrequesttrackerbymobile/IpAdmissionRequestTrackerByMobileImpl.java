...
@Service("ipAdmissionRequestTrackerByMobile")
public class IpAdmissionRequestTrackerByMobileImpl implements IpAdmissionRequestTrackerByMobile {

    private final Logger log = LoggerFactory.getLogger(IpAdmissionRequestTrackerByMobileImpl.class);
    ...
    public List<IpAdmissionRequestDTO> getIpRequestSearch(PatientSearchCriteria patientSearchCriteria, Pageable pageable) {
        ...
        try {
            log.debug("IpAdmissionRequestTrackerByClinicLocationImpl ==> Call to retrieve IpAdmissionRequest by Mobile");
            ...
            if (patientSearchCriteria.getClinicId() != null & patientSearchCriteria.getSearchType() != null
                ...
                whereClause = " where ipr.recordStatus = 1 and p.registered = TRUE and cl.id= " + patientSearchCriteria.getClinicLocationId()
                        + " and p.mobileNumber = '" + patientSearchCriteria.getSearchValue() + "' ORDER BY ipr.createdOn DESC";
