package com.erx.microservice.patientmanagement.service.iprequest.ipadmissionrequesttracker.ipadmissionrequesttrackerbymrn;
...
@Service("ipAdmissionRequestTrackerByMRN")
public class IpAdmissionRequestTrackerByMRNImpl implements IpAdmissionRequestTrackerByMRN {

    private final Logger log = LoggerFactory.getLogger(IpAdmissionRequestTrackerByMRNImpl.class);
    ...
    public List<IpAdmissionRequestDTO> getIpRequestSearch(PatientSearchCriteria patientSearchCriteria, Pageable pageable) {
        ...
        try {
            log.debug("IpAdmissionRequestTrackerByClinicLocationImpl ==> Call to retrieve IpAdmissionRequest by MRN");
            ...
            if (patientSearchCriteria.getClinicId() != null & patientSearchCriteria.getSearchType() != null
                ...
                whereClause = " where ipr.recordStatus = 1 and cl.id= " + patientSearchCriteria.getClinicLocationId()
                        + " and p.patientIdExternal = '" + patientSearchCriteria.getSearchValue() + "' ORDER BY ipr.createdOn DESC";
