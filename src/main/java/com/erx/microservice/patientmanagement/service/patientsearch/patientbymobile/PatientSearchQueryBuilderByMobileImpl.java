...
@Service("patientSearchQueryBuilderByMobile")
public class PatientSearchQueryBuilderByMobileImpl implements PatientSearchQueryBuilderByMobile {
    ...
    public List<PatientSearchDTO> getPatientSearchResults(PatientSearchCriteria patientSearchCriteria) {
        ...
        try {
            ...
            if (patientSearchCriteria.getClinicId() != null & patientSearchCriteria.getSearchType() != null & patientSearchCriteria.getSearchValue() != null) {
                whereClause = " where p.recordStatus= 1 and p.registered = TRUE and NOT p.patientIdExternal=null and p.clinic.id= " + patientSearchCriteria.getClinicId() + " and p.mobileNumber = '" + patientSearchCriteria.getSearchValue() + "'";
