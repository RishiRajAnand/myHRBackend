...
@Service("patientCaseCountSearchQueryBuilderByName")
public class PatientCaseCountSearchQueryBuilderByNameImpl implements PatientCaseCountSearchQueryBuilderByName {
    private final Logger log = LoggerFactory.getLogger(PatientCaseCountSearchQueryBuilderByNameImpl.class);
    ...
    public Page<PatientCaseCountSearchDTO> getPatientSearchResults(PatientSearchServiceRequest request) {
       ...
       Page<PatientCaseCountSearchDTO> patientCaseCountSearchDTOPage = null;
        try {
            ...
            patient = patientRepository.getPatientDetailsByName(request.getPatientSearchCriteria().getClinicId(),request.getPatientSearchCriteria().getSearchValue(),pageable);
            if(patient != null)
            ...
            log.error("failed to retrieve patient and case count based on patient name");
        }
