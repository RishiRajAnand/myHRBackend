...
public class ITBedConfigurationMasterRepositoryTest {
    ...
    public void testRoomConfigurationRepository() throws Exception {
        ...
        bedConfigurationMaster.setBedCode("BED234");
        bedConfigurationMaster.setAllocatedStatus("availability");
        bedConfigurationMaster.setClinicLocationId(30L);
        ...
        //Given
        BedConfigurationMaster bedConfigurationMaster1 = bedConfigurationMasterRepository
                .findOne(savedBedConfigurationMaster.getId());

        //Then
        Assert.assertNotNull(bedConfigurationMaster1);
        Assert.assertNotNull(bedConfigurationMaster1.getId());
        Assert.assertNotNull(bedConfigurationMaster1.getBedNumber());

        //When
        bedConfigurationMasterRepository.delete(savedBedConfigurationMaster.getId());

        //Then
        boolean isDeleted = bedConfigurationMasterRepository.exists(savedBedConfigurationMaster.getId());
        assertFalse(isDeleted);

        //*********************BedConfigurationMaster**********************

        //When (RoomConfigurationMaster)
